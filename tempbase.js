                                    ...
                                    (e.onScroll = function (e) {
                                        if (e.stickySidebar.is(":visible"))
                                            if (i("body").width() < e.options.minWidth) p();
                                                ...
                                                if (e.options.disableOnResponsiveLayouts) if (e.sidebar.outerWidth("none" == e.sidebar.css("float")) + 50 > e.container.width()) return void p();
                                                var o,
                                                    a,
                                                ...
                                                if ("fixed" == n) {
                                                    ...
                                                    "absolute" != e.stickySidebar.css("position") &&
                                                        ((v.position = "absolute"), (v.transform = "translateY(" + (s + m - e.sidebar.offset().top - e.stickySidebarPaddingTop - e.stickySidebarPaddingBottom) + "px)"), (v.top = "0px")),
                                                        (v.width = r(e.stickySidebar) + "px"),
                                                        (v.left = ""),
                                                        e.stickySidebar.css(v);
                                                } else "static" == n && p();
                                                "static" != n && 1 == e.options.updateSidebarHeight && e.sidebar.css({ "min-height": e.stickySidebar.outerHeight() + e.stickySidebar.offset().top - e.sidebar.offset().top + e.paddingBottom }),
...
!(function (o) {
    o.fn.lazyify = function () {
        return this.each(function () {
            ...
            (noThumbnail = "undefined" != typeof noThumbnail ? noThumbnail : "//4.bp.blogspot.com/-eALXtf-Ljts/WrQYAbzcPUI/AAAAAAAABjY/vptx-N2H46oFbiCqbSe2JgVSlHhyl0MwQCK4BGAYYCw/s72-c/nth-ify.png"),
    ...
    var n = function (n) {
            return this.each(function () {
                var e,
                    ...
                    r = this.tagName,
                    d = 0;
                (e = t.extend({ content: "body", headings: "h1,h2,h3" }, { content: c.toc || void 0, headings: c.tocHeadings || void 0 }, n)),
                    (a = e.headings.split(",")),
                    t(e.content)
                        .find(e.headings)
...
!(function (e) {
    ...
    function i() {
        for (var e, n, o = 0, r = {}; o < arguments.length; o++) for (e in (n = arguments[o])) r[e] = n[e];
        return r;
    }
    function c(e) {
    ...
    return (
        ...
        (u.remove = function (e, n) {
            return u(e, "", i(n, { expires: -1 })), !u(e);
        }),
        e && ((e.cookie = u), (e.removeCookie = u.remove)),
        u
    );
});
