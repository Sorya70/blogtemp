...
function getPostAuthor(e, t, a, o) {
    return (
        ...
        exportify.postAuthor ? '<span class="entry-author mi">' + o + '<span class="author-name">' + e[t].author[0].name.$t + "</span></span>" : ""
    );
}
function getPostDate(e, t, a, o, r, i) {
    ...
    return (
        ...
        [
            1 == exportify.postDate ? '<span class="entry-time mi">' + i + '<time class="published" datetime="' + s + '">' + d + "</time></span>" : "",
            1 == exportify.postDate ? '<span class="entry-time mi"><time class="published" datetime="' + s + '">' + d + "</time></span>" : "",
        ]
    );
}
...
function getPostComments(e, t, a, o) {
    var r = e[t].author[0].name.$t,
        ...
        s = e[t].title.$t;
    return (
        (i.match("//img1.blogblog.com/img/blank.gif") || i.match("//img1.blogblog.com/img/b16-rounded.gif")) &&
            ...
            $.ajax({
                ...
                success: function (a) {
                    var r = "",
                        i = -1,
                        s = a.feed.entry;
                    if ("related" == t && null != s) for (var n = 0, l = s; n < l.length; n++) clink == l[n].link.slice(-1)[0].href && (i = n);
                    switch (t) {
                        case "msimple":
...
function beautiAvatar(e) {
    $(e).attr("src", function (e, t) {
        return (t = (t = t.replace("//resources.blogblog.com/img/blank.gif", "//4.bp.blogspot.com/-oSjP8F09qxo/Wy1J9dp7b0I/AAAAAAAACF0/ggcRfLCFQ9s2SSaeL9BFSE2wyTYzQaTyQCK4BGAYYCw/s39/avatar.jpg")).replace(
...
function fixedSidebarIfy(e) {
    $(e).each(function (e) {
        (fixedSidebar = "undefined" == typeof fixedSidebar || fixedSidebar),
            1 == fixedSidebar && ((e = 1 == fixedMenu ? 89 : 30), $(this).theiaStickySidebar({ containerSelector: "#content-wrapper > .container", additionalMarginTop: e, additionalMarginBottom: 30 }));
    });
}
(window.location.hash = ""),
    $(window).on("load", function () {
        target && $("html, body").animate({ scrollTop: $("#" + target).offset().top }, 700, "swing", function () {}),
            $('a[href*="#"]:not(".tocify-wrap a")').on("click", function (e) {
                ...
                (a.hash = ""), (o.hash = ""), t && $(t).length && a.href == o.href && (e.preventDefault(), $("html, body").animate({ scrollTop: $(t).offset().top - 10 }, 750));
            });
    }),
    (fixedMenu = "undefined" == typeof fixedMenu || fixedMenu),
    (viewAllText = "undefined" != typeof viewAllText ? viewAllText : exportify.viewAll),
    $("#crimehelpline-pro-main-nav").menuify(),
    $("#crimehelpline-pro-main-nav .widget").addClass("show-menu"),
    ...
    $(".post-body b").each(function () {
        ...
        t.match("{contactform}") && (e.replaceWith('<div class="contact-form"/>'), $(".contact-form").append($("#ContactForm1"))),
            ...
            t.match("{rightsidebar}") && ($("body").addClass("is-right").removeClass("is-left"), e.remove()),
            t.match("{fullwidth}") && ($("body").addClass("no-sidebar"), e.remove());
    }),
    $("#crimehelpline-pro-new-before-ad").each(function () {
        var e = $(this);
        e.length && $("#before-ad").appendTo(e);
    }),
    $("#crimehelpline-pro-new-after-ad").each(function () {
        var e = $(this);
        e.length && $("#after-ad").appendTo(e);
    }),
    $("#crimehelpline-pro-main-before-ad .widget").each(function () {
        var e = $(this);
        e.length && e.appendTo($("#before-ad"));
    }),
    $("#crimehelpline-pro-main-after-ad .widget").each(function () {
        var e = $(this);
        e.length && e.appendTo($("#after-ad"));
    }),
    $("#crimehelpline-pro-post-footer-ads .widget").each(function () {
        var e = $(this);
    ...
    $(".crimehelpline-pro-share-links").each(function () {
        var e = $(this);
    ...
    $(".about-author .author-text").each(function () {
        ...
        t.each(function () {
            ...
            t.length && e.parent().append('<ul class="author-links social social-color"></ul>'),
            e.find("li").appendTo(".author-links");
    }),
    $("#crimehelpline-pro-main-nav-menu li.mega-menu").each(function (e, t) {
        var a = $(this),
    ...
    $(".crimehelpline-pro-widget-ready .HTML .widget-content").each(function (e, t, a, o) {
        var r = $(this),
            i = $(window),
            s = r.data("shortcode");
        null != s &&
    ...
    $("#crimehelpline-pro-related-posts .HTML").each(function (e, t) {
        var a = [];
        $(".crimehelpline-pro-related-content meta").each(function () {
        ...
        if (null != o) {
            ...
            $("#related-wrap").each(function (e, t) {
                var o = $(this),
                    i = $(window),
                    s = o.find(".crimehelpline-pro-related-content"),
                    n = r();
                (e = 0 != n[1] ? n[1] : 3),
    ...
    $(".crimehelpline-pro-blog-post-comments").each(function () {
        var e = $(this),
            t = e.data("shortcode"),
    ...
    $(function () {
        $(".entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar,#particle, .ratio-16-10").lazyify(),
            $("#crimehelpline-pro-mobile-menu").each(function () {
                var e = $(this),
                    t = $("#crimehelpline-pro-main-nav-menu").clone();
                t.attr("id", "main-mobile-nav"),
                    ...
                    t.appendTo(e),
                    $(".mobile-menu-toggle, .hide-crimehelpline-pro-mobile-menu, .overlay").on("click", function () {
                        $("body").toggleClass("nav-active");
                    }),
                    $(".crimehelpline-pro-mobile-menu .has-sub").append('<div class="submenu-toggle"/>'),
                    $(".crimehelpline-pro-mobile-menu .mega-menu").find(".submenu-toggle").remove(),
                    $(".crimehelpline-pro-mobile-menu ul li .submenu-toggle").on("click", function (e) {
            ...
            $(".mm-footer .mm-social").each(function () {
                var e = $(this),
                    t = $("#crimehelpline-pro-about-section ul.social").clone();
            ...
            $("#crimehelpline-pro-load-more-link").each(function () {
                var e = $(this).data("load");
                e && $("#crimehelpline-pro-load-more-link").show(),
                    $("#crimehelpline-pro-load-more-link").on("click", function (t) {
                        $("#crimehelpline-pro-load-more-link").hide(),
                            $.ajax({
                                url: e,
                                success: function (t) {
                                    ...
                                    a.find(".index-post").addClass("post-animated post-fadeInUp"),
                                        ...
                                        (e = $(t).find("#crimehelpline-pro-load-more-link").data("load")) ? $("#crimehelpline-pro-load-more-link").show() : ($("#crimehelpline-pro-load-more-link").hide(), $("#blog-pager .no-more").addClass("show"));
                                },
                                beforeSend: function () {
            ...
            $("#crimehelpline-pro-cookie-ify").each(function () {
                var e = $(this),
                    t = e.find(".widget.Text").data("shortcode");
                null != t && ((ok = shortCodeIfy(t, "ok")), (days = shortCodeIfy(t, "days")), 0 != ok && e.find("#crimehelpline-pro-cookie-ify-accept").text(ok), 0 != days ? (days = Number(days)) : (days = 7)),
                    e.length > 0 &&
                        ("1" !== $.cookie("crimehelpline_pro_cookie_ify_consent") &&
                            (e.css("display", "block"),
                            $(window).on("load", function () {
                                e.addClass("is-visible");
                            })),
                        $("#crimehelpline-pro-cookie-ify-accept")
                            .off("click")
                            .on("click", function (t) {
                                t.preventDefault(),
                                    t.stopPropagation(),
                                    $.cookie("crimehelpline_pro_cookie_ify_consent", "1", { expires: days, path: "/" }),
            ...
            $("#back-top").each(function () {
                ...
                $(window).on("scroll", function () {
                    var t = window.innerHeight,
                        a = $("#crimehelpline-pro-cta2-section ul.cta-containter");
                    $(this).scrollTop() >= 100
                        ? (e.fadeIn(170), a.hasClass("has-backtop") || (a.animate({ bottom: "+=46px" }, 170), a.addClass("has-backtop")))
                        : (e.fadeOut(170), a.hasClass("has-backtop") && (a.animate({ bottom: "-=46px" }, 170), a.removeClass("has-backtop"))),
                        e.hasClass("on-footer") && !a.hasClass("get-footer") && (a.animate({ bottom: "-=46px" }, 170), a.addClass("get-footer")),
                        !e.hasClass("on-footer") && a.hasClass("get-footer") && (a.animate({ bottom: "+=46px" }, 170), a.removeClass("get-footer")),
                        $(this).scrollTop() + t >= $("#footer-wrapper").offset().top + 36 ? e.addClass("on-footer") : e.removeClass("on-footer");
                }),
                    e.on("click", function () {
